    ...
    class Program
    {
            ...
            static void SendMessageFromSocket(int port)
        {
            ...
            while (inputString.Contains("(-"))
            {
                ...
                String s1 = inputString.Substring(position + 1);
                int position2 = s1.IndexOf(")");
                String s2 = s1.Substring(1, position2 - 1);
                String x1 = inputString.Substring(0, position);
                String x2 = s1.Substring(position2 + 1);
